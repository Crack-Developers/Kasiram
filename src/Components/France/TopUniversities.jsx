...
const universities = [
  ...
  'HEC Paris',
  'Grenoble INP',
  'INSEAD (Top global business school)',
  'University of Strasbourg',
  'École Normale Supérieure (ENS Paris)'
];

const TopUniversitiesFrance = () => {
  return (
    <section className="py-20 px-6 md:px-20 bg-gray-50">
      <div className="max-w-6xl mx-auto text-center mb-14">
        ...
        <p className="text-lg text-gray-600">
          Explore the leading universities in France known for their academic excellence.
        </p>
      </div>
      ...
      <div className="max-w-4xl mx-auto mt-16 grid md:grid-cols-2 gap-6">
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm text-gray-700">
              France is home to some of the world’s top universities, including institutions like <strong>École Polytechnique</strong> and <strong>HEC Paris</strong>.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm text-gray-700">
              Leading fields of study include <strong>Business, Engineering, Political Science, Fashion, AI, Culinary Arts</strong>, and more.
            </p>
          </div>
        </motion.div>
      </div>
...
export default TopUniversitiesFrance;
