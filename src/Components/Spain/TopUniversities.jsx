...
const universities = [
  ...
  'IE Business School – Top-ranked globally',
    ...
    <section className="py-20 px-6 md:px-20 bg-gray-50">
      <div className="max-w-6xl mx-auto text-center mb-14">
        ...
        <p className="text-lg text-gray-600">
          Explore the leading universities in Spain, offering a wide range of programs in various fields of study.
        </p>
      </div>
      ...
      <div className="max-w-4xl mx-auto mt-16 grid md:grid-cols-2 gap-6">
        ...
        >
          ...
          <div>
            <h4 className="text-lg font-semibold text-gray-800 mb-1">Top Business Schools</h4>
            <p className="text-sm text-gray-700">
              Spain is home to some of the world's best business schools, such as IE Business School and ESADE Business School.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div>
            <h4 className="text-lg font-semibold text-gray-800 mb-1">Specializations</h4>
            <p className="text-sm text-gray-700">
              Spain is known for programs in <strong>Business, Hospitality, Architecture, Arts, International Relations, and Sports Management</strong>.
            </p>
          </div>
        </motion.div>
      </div>
...
export default TopUniversitiesSpain;
