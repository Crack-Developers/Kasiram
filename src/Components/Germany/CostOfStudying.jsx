  ...
  return (
    <section className="py-16 bg-gray-100">
      <div className="container mx-auto text-center px-4">
        <h2 className="text-4xl font-bold text-blue-600 mb-6">Cost of Studying in Germany</h2>
        <p className="text-xl mb-12 text-gray-700">
          Here's a breakdown of the tuition fees, living costs, and other expenses to help you plan your journey to study in Germany.
        </p>
        ...
        <div className="mb-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-lg transform transition duration-500 hover:scale-105">
              ...
              <p className="text-lg text-gray-600">No tuition fees for most courses (except minor semester fees: €250–€350 per semester)</p>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-lg transform transition duration-500 hover:scale-105">
              <h4 className="text-2xl font-semibold mb-2">Private Universities</h4>
              <p className="text-lg text-gray-600">€10,000 – €20,000/year</p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-3xl mx-auto transform transition duration-500 hover:scale-105">
            <p className="text-lg text-gray-600 mb-2">Approx. €850–€1,100 per month (housing, food, insurance, etc.)</p>
            <p className="text-lg text-gray-600">Proof of funds: Show €11,208 in a blocked account for visa</p>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-3xl mx-auto transform transition duration-500 hover:scale-105">
            <p className="text-lg text-gray-600">€12,000 – €21,000 (including tuition & living costs)</p>
          </div>
        </div>
      </div>
    </section>
