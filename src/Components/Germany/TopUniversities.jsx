    ...
    <section className="py-20 px-6 md:px-20 bg-gray-50">
      <div className="max-w-6xl mx-auto text-center mb-14">
        ...
        <p className="text-lg text-gray-600">
          Explore the leading universities in Germany, known for their strong focus on technical and scientific research.
        </p>
      </div>
      ...
      <div className="max-w-4xl mx-auto mt-16 grid md:grid-cols-2 gap-6">
        ...
        >
          ...
          <div>
            <h4 className="text-lg font-semibold text-gray-800 mb-1">TU9 Alliance</h4>
            <p className="text-sm text-gray-700">
              Germany’s elite group of technical universities known for research excellence.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm text-gray-700">
              Germany is particularly strong in <strong>Mechanical Engineering, Automotive, Electrical Engineering, Computer Science, and Physics</strong>.
            </p>
          </div>
        </motion.div>
      </div>
...
export default TopUniversitiesGermany;
