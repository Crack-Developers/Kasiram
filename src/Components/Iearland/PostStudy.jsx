...
const postStudyData = [
  {
    ...
    title: 'Stay Back Option (Ireland’s Graduate Scheme)',
    description: '1 year (Bachelor’s graduates), 2 years (Master’s graduates)',
  },
  {
    icon: <FaLaptop className="text-4xl text-blue-500" />,
    title: 'In-Demand Job Sectors',
    description: 'IT, Data Analytics, AI, Biotechnology, Finance, Engineering',
  },
  {
    icon: <FaBuilding className="text-4xl text-green-600" />,
    title: 'Top Employers in Ireland',
    description: 'Google, Apple, Facebook, Accenture, Intel, and more.',
  },
];
    ...
    <section className="py-20 px-6 md:px-20 bg-gray-200">
      <div className="max-w-6xl mx-auto text-center mb-14">
        <h2 className="text-4xl md:text-5xl font-extrabold text-gray-800 mb-4">
          Post-Study Work & Jobs in Ireland 💼🎓
        </h2>
        <p className="text-lg text-gray-600">
          Unlock amazing career opportunities after your studies in Ireland.
        </p>
      </div>
      ...
      <div className="mt-16 text-center p-6 bg-gradient-to-r from-blue-500 to-green-500 text-white rounded-xl shadow-xl">
        ...
        >
          ...
          <p className="text-xl md:text-2xl">Work in high-demand sectors like IT, AI, and Biotechnology with great pay in Ireland!</p>
        </motion.div>
      </div>
    </section>
  );
