...
const Navbar = () => {
  ...
  return (
    <div>
      ...
      <div className="bg-primary text-white text-lg hidden md:block">
        <div className="max-w-screen-xl mx-auto flex justify-between items-center px-4 py-2" data-aos="fade-down">
          {/* Left: Email */}
          <div className="flex items-center space-x-2">
            <MdEmail className="mr-1" />
            <span className="text-lg">kasiramoverseas@gmail.com</span>
          </div>
          {/* Right: Phone */}
          <div className="flex items-center space-x-2">
            <MdPhone className="mr-1" />
            <span className="text-lg">+91 86808 00440</span>
          </div>
        </div>
      </div>
